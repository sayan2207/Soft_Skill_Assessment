<br><br>
<?php
$db= $conn1; // update with your database connection
$id= 0;
?>
   ...
   while($data=$res1->fetch_assoc()){
	...
	$id=$data['id'];
   	...
   	<tr>
   		...
   		<td><a  href="dashboard.php?cat=student-details&subcat=student-profile&view=<?php echo $data['id']; ?>" class="text-secondary content-link"><i class='far fa-eye'></i></a></td>
   	</tr>
   	<?php
   $i++;}
}else{
